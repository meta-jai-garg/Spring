...
<td><input type="text" id="dateOfJoining" name="dateOfJoining" /></td>
</tr>
<tr>
<td>Reporting Manager:</td>
<td><input type="text" id="reportingManager" name="reportingManager" /></td>
</tr>
<tr>
<td>Team Lead:</td>
<td><input type="text" id="teamLead" name="teamLead" /></td>
</tr>
<tr>
<td>Project Id:</td>
